%%%---------------------------------------------------------------------
%%% Description module world_servsup
%%%---------------------------------------------------------------------
%%% The supervisor of the socket server which holds the listening
%%% socket. For each incoming connection request a new child is used and
%%% monitored.
